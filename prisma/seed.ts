...
async function main() {
  ...
  await prisma.item.create({
    data: {
      ...
      photoUrls: ['https://images.unsplash.com/photo-1504280650214-41d1e4eb41ce?q=80&w=2000&auto=format&fit=crop'],
      pricePerDay: 45,
      deposit: 500,
      averageRating: 4.9,
      reviewCount: 24
  ...
  await prisma.item.create({
    data: {
      ...
      photoUrls: ['https://images.unsplash.com/photo-1516035069371-29a1b244cc32?q=80&w=1000&auto=format&fit=crop'],
      pricePerDay: 60,
      deposit: 800,
      averageRating: 4.8,
      reviewCount: 18
